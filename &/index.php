...
$Bkniha=$_POST["Bkniha"];
$Objekt=$_POST["Objekt"];
$Sklad="<Tr><Td>$Priezvisko</Td><Td>$Meno</Td><Td>$Objekt</Td><Td>$Aautor</Td><Td>$Akniha</Td><Td>$Bautor</Td><Td>$Bkniha</Td><Td>$Datum</Td><Td>On$A</Td></Tr>"."\r\n";
...
<Body Onload="Tikat('***','Tre');">
<Header data-intro="Zdravím :) Tady si můžeš zapsat referáty" data-position="bottom" data-step="1">&</Header>
...
<Footer Class="Prvky" Id="Tre" Title="***" data-intro="a pokud na to máš vůbec ještě čas :D" data-step="3"></Footer>
