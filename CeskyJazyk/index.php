...
$Cautor=$_POST["Cautor"];
$Ckniha=$_POST["Ckniha"];
$Sklad="<Tr><Td>$Priezvisko</Td><Td>$Meno</Td><Td><B>$Aautor: $Akniha</B></Td><Td>$Bautor: $Bkniha</Td><Td>$Cautor: $Ckniha</Td></Tr>"."\r\n";
$Funkce=fopen("Zapisy.html","a+");
fwrite($Funkce,$Sklad);
fclose($Funkce);
header('Location: /CeskyJazyk/index.php');
}
?>
<!Doctype Html>
<Html Lang="cs">
...
<Title>Zápis referátů | Český jazyk</Title>
</Head>
<Body Onload="Tikat('2013-11-07T20:00','Uno');">
<Header data-intro="Zdravím :) Tady si můžeš zapsat referáty" data-position="bottom" data-step="1">Český jazyk</Header>
...
<A Id="Podklady" Onclick="Vybalit('Podklady');" Title="Podklady a tipy" data-intro="ale před zápisem si tady musíš ještě vybrat" data-step="4">Podklady</A>
<A Id="Odchod" Onclick="Vybalit('Odchod');" Title="Získání protokolu">Vyjet</A>
<A Id="Pomoc" Onclick="introJs().start();" Title="Pomoc">?</A>
</Nav>
<Footer Class="Prvky" Id="Uno" Title="7. listopadu 2013 20:00" data-intro="a pokud na to máš vůbec ještě čas :D" data-step="3"></Footer>
